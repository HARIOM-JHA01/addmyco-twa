        ...
        <div className="flex justify-center w-full">
            <div className="flex items-center justify-between px-2 py-2 bg-[#007cb6] rounded-full w-full max-w-3xl mt-4 shadow-lg mx-4">
                <div className="flex items-center gap-1">
                    ...
                    <span className="text-white text-2xl font-space-bold tracking-wide">AddMy.Co</span>
                </div>
                <div className="flex items-center gap-2">
                    ...
                    <img src={notification} alt="Bell" className="w-8 h-8 rounded-full border-2 border-white bg-white" onClick={() => navigate('/notifications')} />
                    <img src={dynamicNameCardLogo} alt="Profile" className="w-8 h-8 rounded-full border-2 border-white bg-white" onClick={() => window.open('https://t.me/dynamicnamecard', '_blank')} />
                </div>
            </div>
        </div>
    );
