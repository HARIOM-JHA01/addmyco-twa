    ...
    >
      ...
      <div className="flex flex-col items-center px-4 justify-start flex-1 pb-32">
        <div className="w-full max-w-md rounded-xl mt-8 shadow-xl bg-white/90">
          <h2 className="text-2xl font-bold justify-center text-center text-[#2fa8e0] mb-4">
            {isPremium
          ...
          <div className="text-center justify-center mt-4 text-lg font-semibold text-pink-700">
            {isPremium ? (
              <>
