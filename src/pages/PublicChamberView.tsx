        ...
        <div className="bg-blue-100 bg-opacity-40 rounded-3xl p-4 w-full max-w-md mx-auto flex flex-col items-center shadow-lg">
          ...
          <div className="relative w-full mb-2">
            <button
              ...
              className="absolute -left-2 top-1/2 -translate-y-1/2 z-20 p-2 bg-white/10 rounded-full"
              style={{
            ...
            <button
              ...
              className="absolute -right-2 top-1/2 -translate-y-1/2 z-20 p-2 bg-white/10 rounded-full"
              style={{
