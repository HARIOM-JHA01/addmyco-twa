...
import qrImage from '../assets/scannerIcon.png';
export default function MyQRPage() {
    const qrLink = "https://addmy.co/6500b34d";
        ...
        <Layout>
            <div className="flex flex-col items-center justify-center flex-grow py-4 px-2 pb-32">
                <div className="bg-blue-100 bg-opacity-40 rounded-3xl p-6 w-full max-w-md mx-auto flex flex-col items-center shadow-lg">
                    {/* Copy QR Code */}
                    <div className="flex items-center gap-2 mb-4 cursor-pointer" onClick={() => copyToClipboard(qrLink)}>
                    ...
                    <div className="flex items-center bg-white rounded-full px-4 py-2 mb-4 w-full max-w-xs cursor-pointer" onClick={() => copyToClipboard(qrLink)}>
                        <input
                            type="text"
                            value={qrLink}
                            readOnly
